...
* **Artifacts:** The resulting telemetry has been captured and exported as an initial JSON dataset (`artifacts/release/detection_metrics.json`). Future evaluations in Week 16 will incorporate `.pcap` files capturing sustained synthetic attacks.
